...
def load_corpus(
    url: str = "https://huggingface.co/datasets/cnn_dailymail/resolve/script/data/cnn_stories.tgz",
    ...
    dir_to_text = lambda f: open(os.path.join(text_dir, f), encoding="utf-8").read()
