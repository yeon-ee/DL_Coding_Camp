...
# TODO 4-1: Debug and fix the AttributeError 완
# TODO 4-2: Fix the bug of ls -l -t -h now showing the file in order of modified time. 완
# TODO 4-3: Fix the bug of ls (when no options are specified) 완
